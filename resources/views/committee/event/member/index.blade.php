...
<div class="header pb-8 pt-5 pt-md-8">
    <div class="container-fluid">
        ...
        <div class="header-body">{{ Breadcrumbs::render('committee.event.member', $events->id) }}</div>
    </div>
</div>
            ...
            <div class="card shadow">
                <div id="contacts">
                    <div class="card-header border-0">
                        ...
                        <form action="{{ route('committee.event.member.store') }}" method="post">
                            {{ csrf_field() }}
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    <th class="sort" data-sort="name" style="width: 270px;cursor: pointer;">Name <span><i class="fas fa-sort"></i></span></th>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <form action="{{ route('committee.event.member.destroy', $user->id) }}" method="post">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('committee.event.edit', $user->id) }}">{{ __('Edit') }}</a>
