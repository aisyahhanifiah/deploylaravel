...
@section('title', 'Attendees for ' .$meetings->name.' |')

@section('content')
<div class="header pb-8 pt-5 pt-md-8">
    <div class="container-fluid">
        <div class="col-md-12"><h1 class="display-2 ">Committee</h1></div>
        <div class="header-body">{{ Breadcrumbs::render('committee.meeting.member', $meetings->id) }}</div>
    </div>
</div>
            ...
            <div class="card shadow">
                <div id="contacts">
                    <div class="card-header border-0">
                        ...
                        <form action="{{ route('committee.meeting.member.store') }}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="row align-items-center">
                                ...
                                <input name="meeting_id" type="hidden" value="{{ $meetings->id }}">
                                <div class="col-md-3">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-md-4">
                                <h3 class="mb-0">{{ __('All Meeting Attendees') }}</h3>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-2 text-md-right text-left py-2">
                                ...
                                <a href="{{ route('memberformeeting.export', $meetings->id) }}" class="btn btn-sm btn-primary">{{ __('Generate Report') }}</a>
                            </div>
                            <div class="col-md-2 text-md-right text-left py-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md align-items-center table-flush">
                            ...
                            <tbody  class="list">
                                @foreach ($meetings->users as $user)
                                <tr>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <form action="{{ route('committee.meeting.member.destroy', $user->id) }}" method="post">

                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}

                                                    <input name="meetingid" type="hidden" value="{{ $meetings->id }}">
